...
{
meta:
	description = "detects Win32 files signed with stolen code signing key used in Kingslayer attack - https://blogs.rsa.com/kingslayer-a-supply-chain-attack/" 
	author = "RSA Research - <NetWitness.Content@rsa.com>"
